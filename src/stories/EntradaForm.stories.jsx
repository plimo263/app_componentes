    ...
    componentSubtitle: (
      ...
      automaticamente monta os campos.`}</p>
        ...
        <ul>
          ...
          <li>{`wrapperPaperProps: Um objeto para estilizar o wrapper que envolve cada campo do formulario (Paper)...`}</li>
        </ul>
      </div>
    ),
  },
...
ComSchemaValidator.story = {
  parameters: {
    docs: {
      storyDescription:
        "Recebe um schemaValidator para exibir mensagens de erro caso não seja atendido o formulario.",
    },
  },
};
...
ComIcones.story = {
  parameters: {
    docs: {
      storyDescription:
        "Strings com os Icones são passados para serem criados (ver lista de icones aceito no componente Icone).",
    },
  },
};
...
Aguardar.story = {
  parameters: {
    docs: {
      storyDescription:
        "Com o valor que desativa todos os campos (geralmente repassado quando um formulario e submetido).",
    },
  },
};
...
ExibirSe.story = {
  parameters: {
    docs: {
      storyDescription:
        "Formulário que exibe um campo se o outro já tiver valor preenchido",
    },
  },
};
...
ComMaskToMoney.story = {
  parameters: {
    docs: {
      storyDescription:
        "Formulario com autoformatacao para campo monetario usando a props toMoney no item a ser formatado. Neste exemplo o tamanho máximo é 4 numero inteiros e 2 decimais.",
    },
  },
};
...
ComMask.story = {
  parameters: {
    docs: {
      storyDescription:
        "Formulario com formatacao para campo numérico customizado",
    },
  },
};
